...
CREATE TABLE IF NOT EXISTS posts (
    ...
    created_at TIMESTAMP /* [jooq ignore start] */NOT NULL DEFAULT LOCALTIMESTAMP/* [jooq ignore stop] */,
    updated_at TIMESTAMP /* [jooq ignore start] */NOT NULL DEFAULT LOCALTIMESTAMP/* [jooq ignore stop] */,
    version INTEGER
);
...
ALTER TABLE posts_tags DROP CONSTRAINT IF EXISTS pk_posts_tags;
...
ALTER TABLE posts_tags ADD CONSTRAINT pk_posts_tags PRIMARY KEY (id);
...
-- add indexes
CREATE UNIQUE INDEX IF NOT EXISTS idx_posts_tags_post_id_tag_id ON posts_tags (post_id, tag_id);
